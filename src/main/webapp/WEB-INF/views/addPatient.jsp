...
<body>
	...
	<form:form method="post" commandName="patientForm" class="smart-green">
		<h1>
			Dodaj pacjenta <span>Proszę wypełnić wszystkie pola.</span>
		</h1>
		...
		<label> <span>Klasyfikacja przypadku :</span> <form:input
				path="patientClassification" type="text" />

		</label>
		<label> <span>Objawy:</span> <form:input path="aliments"
				type="text" />

		</label>
		<center>
			<label> <span>&nbsp;</span> <input type="submit"
				class="button" value="Dodaj pacjenta" />
			</label> </br>
			</br>
			<a class="button" href=<c:url value="/" />><span>Strona
					główna</span></a> <a class="button"
				href=<c:url value="/manage/patients/list" />><span>Lista
					pacjentów</span></a>
		</center>
